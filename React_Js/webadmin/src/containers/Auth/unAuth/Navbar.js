        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#projects" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>Dịch Vụ</Nav.Link>
            </Nav>
            <span className="navbar-text">
              <div className="social-icon">
                <a className="the_a" href="#"><img className="the_img" src={navIcon1} alt="" /></a>
                <a className="the_a" href="#"><img className="the_img" src={navIcon2} alt="" /></a>
                <a className="the_a" href="#"><img className="the_img" src={navIcon3} alt="" /></a>
              </div>
              {/* <HashLink to='#connect'> */}
              <HashLink to='/dang-nhap'>
                <button className="vvd"><span>Đăng Nhập</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
